package grab.com.newsfeed.network.volley;
...
public class VolleyStreamFetcher implements DataFetcher<InputStream> {
  ...
  public static final VolleyRequestFactory DEFAULT_REQUEST_FACTORY = (url, callback, priority, headers) -> new GlideRequest(url, callback, priority, headers);
